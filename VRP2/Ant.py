...
class Ant:
    ...
    def build_route(self, pheromone, alpha, beta):
        ...
        while unvisited:
            ...
            current = depot
            # nie ograniczać tutaj tylko pozwolić mrówkom dowolnie chodzić i w solution_cost dać duży koszt dla niepoprawnych rozwiązań
    ...
    def build_route2(self, pheromone, alpha, beta):
    ...
    def build_route3(self, pheromone, alpha, beta):
